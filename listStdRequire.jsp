								...
								>
									...
									<tbody>
										...
										<tr>
											...
											<td><span class="btn-light-beige btn-xs"><%=list.get(i).getStatusOfReg()%>
											</span></td>
											<td><span class="btn-light-green btn-xs"><a
													href="ApproveStatus.do?id=<%=list.get(i).getRegId()%>"
												>อนุมัติ</a> </span></td>
											<td><span class="btn-light-green btn-xs"><a
													href="RejectStatus.do?id=<%=list.get(i).getRegId()%>"
												>ไม่อนุมัติ</a> </span></td>
