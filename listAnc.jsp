					...
					<div class="row">
						<div class="col-md-3">
							...
							<ul class="nav nav-list blog-categories">
								<li><a href="listAnc.do">ประกาศทุนการศึกษา</a></li>
							</ul>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="post-content">
											...
											<p class="text-dark"><%=anc.getAnnounceSchInfo_Name()%>
												ของ
												<%=anc.getAnnounceSchInfo_Company()%>
												จำนวนเงิน
												<%=anc.getAnnounceSchInfo_Amount()%></p>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="post-meta text-light">
											<span><i class="fa fa-calendar"></i><%=anc.getAnnounceSchInfo_DatePost()%></span>
											<span><i class="fa fa-user"></i> By <a href="#">
													Officer </a> </span> <a
												href="listDetail.jsp?id=<%=anc.getAnnounceSchInfo_Id()%>"
												class="btn btn-primary btn-wide btn-scroll btn-scroll-top fa-arrow-right pull-right"
												data-caption-class="fadeIn" data-caption-delay="900"> <span>อ่านเพิ่มเติม</span>
											</a>
										</div>
									</div>
								</div>
