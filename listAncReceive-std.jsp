								...
								<div class="row margin-bottom-25">
									<div class="col-md-12">
										<div class="post-content">
											<h1 class="text-dark">รายชื่อผู้มีสิทธิ์ได้รับทุนการศึกษา</h1>
											<hr>
											<!-- start: DYNAMIC TABLE -->
																																																																																																																																																																																													...
																																																																																																																																																																																													.lookup("ejb:/HelloEJB/ScholarshipServiceBean!com.mfu.ScholarshipService");
																																																																																																																																																																																																																		...
																																																																																																																																																																																																																		long schrId = Long.parseLong(request.getParameter("id"));
																																																																																																																																																																																																																			...
																																																																																																																																																																																																																			for (int i = 0; i < list.size(); i++) {
																																																																																																																																																																																																																				...
																																																																																																																																																																																																																				if(list.get(i).getStatusReceiveSch().equals("Receive")){
															%>
															<tbody>
																<tr>
																	...
																	<td><span class="label label-sm label-warning"><%=list.get(i).getStatusReceiveSch()%>
																	</span></td>
