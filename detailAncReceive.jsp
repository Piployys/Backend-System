								...
								>
									...
									<tbody>
																																																																																																																																																						...
																																																																																																																																																						ScholarshipService schServ = (ScholarshipService) context
																																																																																																																																																								.lookup("ejb:/HelloEJB/ScholarshipServiceBean!com.mfu.ScholarshipService");
																																																																																																																																																																													...
																																																																																																																																																																													for (RegisterInfo reg : list){
																																																																																																																																																																														if(reg.getStatusOfReg().equals("Approve")){
										%>
										...
										<tr>
											...
											<td><span class="btn-light-beige btn-xs"><%=reg.getStatusReceiveSch()%>
											</span></td>
											<td><span class="btn-light-green btn-xs"><a
													href="Receive.do?id=<%=reg.getRegId()%>"
												>อนุมัติ</a> </span></td>
											<td><span class="btn-light-green btn-xs"><a
													href="Reject.do?id=<%=reg.getRegId()%>"
