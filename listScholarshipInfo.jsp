					...
					<ul class="nav navbar-right">
						...
						<li class="dropdown current-user"><a href
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="assets/images/avatar-1.jpg"> <span class="username">Officer<i
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="row">
							<div class="col-md-10">
								<h5 class="over-title margin-bottom-15">ข้อมูลเกี่ยวกับทุนการศึกษา</h5>
								<div align="right">
									<a href="newScholarshipInfo.do"> <i class="fa fa-pencil"></i>บันทึกข้อมูลเกี่ยวกับทุนการศึกษา
									</a>
								</div>
								<hr>
								<table
									...
									<thead>
										<tr>
											...
											<th class="hidden-xs" align="center">ชื่อทุนการศึกษา</th>
											<th align="center">ชื่อผู้ให้ทุนการศึกษา</th>
									...
									<tbody>
										<c:forEach items="${schList}" var="sch">
											<tr>
												<td align="center">${sch.scholarshipInfo_Id}</td>
												<td class="hidden-xs" align="center"><a
													href="DetailScholarshipInfo.do?id=${sch.scholarshipInfo_Id}">
														${sch.scholarshipInfo_Name} </a></td>
												<td align="center">${sch.scholarshipInfo_Company}</td>
												<td align="center">${sch.scholarshipInfo_DateRecord}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
